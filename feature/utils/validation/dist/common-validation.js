...
exports.signInSchema = exports.changePasswordSchema = exports.signAppSchema = exports.schemaRepeatPasswordValidation = exports.schemaPasswordValidation = exports.schemaEmailValidation = exports.REG_PASSWORD = exports.REG_EMAIL = void 0;
var yup = require("yup");
exports.REG_EMAIL = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
exports.REG_PASSWORD = /^.*((?=.*[!@#$%^&*\:]))(?=.*\d)((?=.*[a-z]))((?=.*[A-Z])).*$/;
...
exports.signAppSchema = yup.object().shape({
...
}).concat(exports.schemaEmailValidation).concat(exports.schemaPasswordValidation).concat(exports.schemaRepeatPasswordValidation);
exports.changePasswordSchema = exports.schemaPasswordValidation.concat(exports.schemaRepeatPasswordValidation);
exports.signInSchema = exports.schemaEmailValidation.concat(exports.schemaPasswordValidation);
